#undef MINESWEEPERTOOLBARPLUGIN_API
...
#define UE_PROJECT_NAME MinesweeperShowcase
#define UE_TARGET_NAME MinesweeperShowcaseEditor
...
#define MINESWEEPERTOOLBARPLUGIN_API DLLEXPORT
